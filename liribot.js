...
function mySwitch(userCommand) {
    ...
    function getTweets() {
        ...
        var screenName = { screen_name: 'spaghetti' };
        ...
        client.get('statuses/user_timeline', screenName, function (error, tweets, response) {
            ...
            for (var i = 0; i < tweets.length; i++) {
                ...
                logOutput("@spaghetti: " + tweets[i].text + " Created At: " + date.substring(0, 19));
    ...
    function getMovie() {
        ...
        request(queryUrl, function (error, response, body) {
            ...
            if (movieName === "Forrest Gump"
                console.log("-----------------------");
                console.log("If you haven't watched 'Forrest Gump', then you should: http://www.imdb.com/title/tt0485947/");
